...
public class WebAuthConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http.sessionManagement()
                ...
                .antMatchers("/contactos", "/crearPerfil/{userID}", "/createEmployee/{userID}", "/editarPerfil", "/editEmployee", "/trabajos", "/filterJobs", "/apply/{jobID}", "/trabajosAplicados").hasAuthority("EMPLOYEE")
