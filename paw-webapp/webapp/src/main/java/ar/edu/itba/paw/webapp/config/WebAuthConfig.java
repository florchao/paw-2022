...
public class WebAuthConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http.cors().configurationSource(corsConfigurationSource())
                ...
                .antMatchers("/", "/api/explore/employees", "/api/explore/jobs",  "/api/profile/hello", "/api/profile/{userId}", "/api/applicant/{jobId}","/api/profile/employer/{userId}", "/filterEmployees", "/contactUs", "/api/profile/image/{userId}","/api/review/employer/{userId}", "/api/review/employee/{userId}", "/api/rating/{userId}", "/filterEmployees", "/api/contact/us", "/api/contact/{id}","/user/profile-image/{userId}", "/api/profile/delete/{userId}", "/api/job/{userId}").permitAll()
