...
public class WebAuthConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http.sessionManagement()
                ...
                .antMatchers("/", "/buscarEmpleadas","/verPerfil/{userId}", "/filterEmployees", "/contactanos","/user/profile-image/{userId}", "/contactUs", "/trabajo/{id}").permitAll()
                ...
                .antMatchers("/contacto/{id}", "/contactarEmpleado/{id}", "/crearPerfilEmpleador/{userID}", "/createEmployer/{userID}", "/misTrabajos", "/crearTrabajo", "/createJob", "/aplicantes/{jobID}").hasAuthority("EMPLOYER")
