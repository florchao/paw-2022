...
public class WebAuthConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http.cors().configurationSource(corsConfigurationSource())
                ...
                .antMatchers("/", "/api/explore/employees", "/api/explore/jobs",  "/api/create/hello", "/api/profile/{userId}", "/api/applicant/{jobId}", "/api/applicant/{id}/jobs", "/api/profile/employer/{userId}", "/filterEmployees", "/contactUs", "/api/profile/image/{userId}","/api/review/employer/{userId}", "/api/review/employee/{userId}", "/api/rating/{userId}", "/filterEmployees", "/api/contact/us", "/api/contact/{id}","/user/profile-image/{userId}", "/api/profile/delete/{userId}", "/api/job/{userId}", "/api/job/employer/{id}", "/api/job/ids", "/api/job", "/api/create/employer", "/api/create/employee").permitAll()
