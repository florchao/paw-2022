...
public class WebAuthConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http.cors().configurationSource(corsConfigurationSource())
                ...
                .antMatchers("/", "/api/employees", "/api/jobs", "/api/employee/{id}", "/api/employee/", "/api/applicant/{jobId}", "/api/applicant/{id}/jobs", "/api/employer/{id}", "/api/employer/", "/filterEmployees", "/contactUs", "/api/image/{id}","/api/review/employer/{userId}", "/api/review/employee/{userId}", "/api/rating/{userId}", "/filterEmployees", "/api/contact/", "/api/contact/{id}","/user/profile-image/{userId}", "/api/user/{id}", "/api/job/{userId}", "/api/job/{id}/employer", "/api/job/ids", "/api/job/", "/api/user/").permitAll()
