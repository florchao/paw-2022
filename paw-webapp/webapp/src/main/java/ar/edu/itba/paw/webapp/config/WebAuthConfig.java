...
public class WebAuthConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http.sessionManagement()
                ...
                .antMatchers("/", "/buscarEmpleadas", "/filterEmployees", "/contactanos","/user/profile-image/{userId}", "/contactUs").permitAll()
                ...
                .antMatchers("/contactos", "/verPerfil", "/crearPerfil/{userID}", "/createEmployee/{userID}", "/editarPerfil", "/editEmployee", "/trabajos", "/filterJobs", "/apply/{jobID}", "/trabajosAplicados").hasAuthority("EMPLOYEE")
                .antMatchers("/contacto/{id}", "/contactEmployee/{id}", "/crearPerfilEmpleador/{userID}", "/createEmployer/{userID}", "/misTrabajos", "/crearTrabajo", "/createJob", "/aplicantes/{jobID}", "/addRating/{idRating}", "/changeStatus/{jobId}/{employeeId}/{status}", "/deleteJob/{jobId}", "/closeJob/{jobId}", "/openJob/{jobId}", "addReview/{id}").hasAuthority("EMPLOYER")
