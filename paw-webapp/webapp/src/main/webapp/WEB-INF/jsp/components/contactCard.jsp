...
<div class="max-w-sm mb-5 mr-5 px-5 w-80 h-80 bg-white rounded-lg border border-gray-200 shadow-md overflow-hidden" >
    ...
    <div class="flex flex-col items-center pb-6 ">
        <img class="object-cover mb-3 w-24 h-24 rounded-full shadow-lg" src="<c:url value="/user/profile-image/${param.employerID}"/>" alt="" onerror="this.src = '<c:url value="/public/user.png"/>'"/>
