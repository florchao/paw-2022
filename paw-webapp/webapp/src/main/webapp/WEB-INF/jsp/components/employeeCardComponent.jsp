...
<body>
    <a href="<c:url value="/verPerfil/${param.id}"/>" class="grid grid-cols-6 items-center bg-white rounded-lg border shadow-md mb-5 md:flex-row md:max-w-full hover:bg-gray-100 ">
        <img class="object-cover w-full h-96 rounded-t-lg md:h-auto md:w-48 md:rounded-none md:rounded-l-lg col-start-1 col-span-1" src="/docs/images/blog/image-4.jpg" alt="">
