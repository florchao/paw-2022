...
<body>
    <a href="<c:url value="/verPerfil/${param.id}"/>" class="flex flex-col items-center bg-white rounded-lg border shadow-md  mt-20 mb-5 md:flex-row md:max-w-full hover:bg-gray-100 ">
        ...
        <div class="flex flex-col justify-between p-4 leading-normal">
            ...
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400"><c:out value="${param.location}"></c:out></p>
