    ...
    <div class=" grid grid-row-4 col-span-4 col-start-2">
        <div class=" bg-gray-200 rounded-3xl overflow-auto p-5 mt-24 mb-5 shadow-2xl">
            <div class="grid grid-cols-5 justify-center">
                <div class="ml-3 mb-2 col-span-5">
                    <p class="text-2xl font-semibold whitespace-nowrap text-ellipsis overflow-hidden"><c:out value="${job.title}"/></p>
                </div>
                <div class="col-span-2">
                    <h1 class="pb-3 pt-3 font-semibold"><spring:message code="viewJob.location"/></h1>
            ...
            <div class="grid grid-cols-2">
                <div class="col-span-1">
                    <h1 class="pb-3 pt-3 font-semibold"><spring:message code="viewJob.abilities"/></h1>
                ...
                <div class="col-span-1 col-start-2">
                    <h1 class="pb-3 pt-3 font-semibold"><spring:message code="viewJob.availability"/></h1>
                    <ul role="list" class="list-inside marker:text-purple-900 list-disc pl-5 space-y-3 text-gray-500">
                ...
                <div class="col-span-5">
                    <h1 class="pb-3 pt-3 font-semibold"><spring:message code="viewJob.description"/></h1>
