...
import jobOffer from '../assets/joboffer.jpeg';
import searchJob from '../assets/searchJob.jpeg'
            ...
            <div id="roles" className="grid grid-cols-2 items-start p-10 gap-y-7 mt-9 content-center">
                <div className="grid grid-cols-3">
                    <div className="h-48 w-48">
                        <img className="object-cover w-full h-full rounded-full" src={searchJob} alt="employer"/>
                    </div>
                ...
                <div className="col-start-2 grid grid-cols-3">
                    <div className="h-48 w-48">
                        <img className="object-cover w-full h-full rounded-full" src={jobOffer} alt="job offer picture"/>
                    </div>
                    <div className="col-span-2">
                        <h3 className="text-2xl text-purple-700 justify-self-center">
