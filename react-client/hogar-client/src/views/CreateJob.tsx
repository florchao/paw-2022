                        ...
                        <div className="bg-gray-200 rounded-3xl p-5 shadow-2xl">
                            <div className="grid grid-cols-6 gap-6">
                                ...
                                <div className="ml-3 col-span-3 w-4/5 justify-self-center">
                                    ...
                                    <input type="number" id="expYears" onChange={(e) => {
                                        setExperienceYears(e.target.valueAsNumber)
                                    }}
                                           // onChange={validateExpYears}
                                           className="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-violet-300 sm:text-xs focus:ring-violet-500 focus:border-violet-500"/>
                                ...
                                {ids &&
                                    <div className="ml-3 col-span-3 w-4/5 justify-self-center">
                                        ...
                                        <select
                                            ...
                                            className="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-violet-300 sm:text-xs focus:ring-violet-500 focus:border-violet-500">
                                            <option value={ids.availabilities[0]} label={t('CreateJob.availability_half')}/>
                                            <option value={ids.availabilities[1]} label={t('CreateJob.availability_complete')}/>
                                            <option value={ids.availabilities[2]} label={t('CreateJob.availability_bed')}/>
                                        </select>
                            ...
                            {ids &&
                                <div className="flex flex-wrap ml-8">
                                    <div className="mb-8">
                                        ...
                                        <input type="checkbox" ref={cookRef} onChange={ (e) => handleCheck(cookRef, e.target.value)} id="cocinar-cb" value={ids.abilities[0]}
                                    ...
                                    <div>
                                        ...
                                        <input type="checkbox" ref={ironRef} onChange={(e) => handleCheck(ironRef, e.target.value)} id="planchar-cb" value={ids.abilities[1]}
                                               style={{visibility: "hidden"}}/>
                                    </div>
                                    <div>
                                        ...
                                        <input type="checkbox" ref={childRef} onChange={(e) => handleCheck(childRef, e.target.value)} id="menores-cb" value={ids.abilities[2]}
                                               style={{visibility: "hidden"}}/>
                                    </div>
                                    <div>
                                        ...
                                        <input type="checkbox" ref={elderRef} onChange={(e) => handleCheck(elderRef, e.target.value)} id="mayores-cb" value={ids.abilities[3]}
                                               style={{visibility: "hidden"}}/>
                                    </div>
                                    <div>
                                        ...
                                        <input type="checkbox" ref={specialRef} onChange={(e) => handleCheck(specialRef, e.target.value)} id="especiales-cb" value={ids.abilities[4]}
                                               style={{visibility: "hidden"}}/>
                                    </div>
                                    <div>
                                        ...
                                        <input type="checkbox" ref={petRef} onChange={(e) => handleCheck(petRef, e.target.value)} id="mascotas-cb" value={ids.abilities[5]}
                                               style={{visibility: "hidden"}}/>
                                    </div>
                                </div>
                            }
