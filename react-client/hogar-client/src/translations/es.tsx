export const TRANSLATIONS_ES = {
    ...
    Home:{
        ...
        title2:"Un lugar para conectarse y encontrar lo que estas buscando.",
        searchEmployee:"Buscar Empleadas",
    ...
    Register:{
        employer:"Empleador",
        employerDesc:"Si sos un empleador vas a poder encontrar a la persona perfecta para que limpie tu casa, cuide tus mascotas ¡y mucho más! Tenemos dos maneras de ayudarte a encontrar tu mejor opción:",
        employerDesc2:"- Creando una publicación según tus preferencias y necesidades.",
        employerDesc3:"- Eligiendo en nuestra comunidad el perfil que encaje con lo que estes buscando y a la vez vas a poder ver opiniones de otros empleadores.",
        employee:"Empleada",
